...
RESNET50_IMAGENET_REGISTERED_LAYERS_ATTRIBUTES = [
...
# Layer 2 - Blocks 1
RESNET50_IMAGENET_REGISTERED_LAYERS_ATTRIBUTES.extend([
...
RESNET50_IMAGENET_REGISTERED_LAYERS_ATTRIBUTES.append(
...
for i in range(1, 5):
    if i == 1:
        RESNET50_IMAGENET_UNREGISTERED_LAYERS_ATTRIBUTES.extend([
...
RESNET50_IMAGENET_UNREGISTERED_LAYERS_ATTRIBUTES.append(
    {"name": "avgpool", "type": "AdaptiveAvgPool2d", "output_size": (1, 1)}
)


# Mapping between custom and standard layer names
RESNET50_IMAGENET_CUSTOM_TO_STANDARD_LAYER_NAME_MAPPING = [
    # Initial layers
...
RESNET50_IMAGENET_STANDARD_TO_CUSTOM_LAYER_NAME_MAPPING = [
    {'standard_name': mapping['standard_name'], 'custom_name': mapping['custom_name']}
    for mapping in RESNET50_IMAGENET_CUSTOM_TO_STANDARD_LAYER_NAME_MAPPING
]
