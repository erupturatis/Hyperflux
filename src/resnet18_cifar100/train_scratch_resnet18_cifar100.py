...
def train_resnet18_cifar100_from_scratch():
    ...
    wandb_initalize(experiment=Experiment.RESNET18CIFAR100, type=Tags.BASELINE)
    ...
    MODEL.save(
        name=f"resnet18_cifar100_accuracy{acc}%_{get_random_id()}",
