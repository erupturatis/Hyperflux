...
class Resnet18Cifar100(LayerComposite):
    def __init__(self, configs_network_masks: ConfigsNetworkMasksImportance):
        ...
        for layer_attr in RESNET18_CIFAR100_REGISTERED_LAYERS_ATTRIBUTES:
        ...
        for layer_attr in RESNET18_CIFAR100_UNREGISTERED_LAYERS_ATTRIBUTES:
            name = layer_attr['name']
            type_ = layer_attr['type']
    ...
    def save(self, name: str, folder:str):
        save_model_weights(
            ...
            model_name=name,
            folder_name=folder,
            custom_to_standard_mapping=RESNET18_CIFAR100_CUSTOM_TO_STANDARD_LAYER_NAME_MAPPING,
            skip_array=[]
        )
    ...
    def load(self, path: str, folder: str):
        load_model_weights(
            ...
            model_name=path,
            folder_name=folder,
            standard_to_custom_mapping=RESNET18_CIFAR100_STANDARD_TO_CUSTOM_LAYER_NAME_MAPPING,
            skip_array=[]
        )