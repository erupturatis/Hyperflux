...
from src.resnet18_cifar100.resnet18_cifar100_attributes import RESNET18_CIFAR100_CUSTOM_TO_STANDARD_LAYER_NAME_MAPPING, \
    RESNET18_CIFAR100_STANDARD_TO_CUSTOM_LAYER_NAME_MAPPING


def run_resnet18_cifar100_existing_model(model_name:str, folder: str):
    ...
    get_sparsity(
        model=model,
        standard_to_custom_attributes=RESNET18_CIFAR100_STANDARD_TO_CUSTOM_LAYER_NAME_MAPPING
    )
