...
from src.cifar10_resnet18.training_net_flow_experiment import run_cifar10_resnet18_training_net_flow_experiment
...
def pipeline_resnet18_averaged_tests():
    run_cifar10_resnet18_training_net_flow_experiment()
