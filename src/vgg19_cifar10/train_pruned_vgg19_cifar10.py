...
def train_vgg19_cifar10_sparse_model(sparsity_configs_aux: TrainingConfigsWithResume):
    ...
    wandb_initalize(Experiment.VGG19CIFAR10, type=Tags.TRAIN_PRUNING, configs=sparsity_configs,other_tags=["ADAM"])
    ...
    MODEL.save(
        name= f"vgg19_cifar10_sparsity{get_custom_model_sparsity_percent(MODEL)}_acc{acc}",
