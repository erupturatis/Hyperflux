...
from src.vgg19_cifar10.vgg19_cifar10_attributes import (
    VGG19_CIFAR10_REGISTERED_LAYERS_ATTRIBUTES,
    VGG19_CIFAR10_UNREGISTERED_LAYERS_ATTRIBUTES,
    VGG19_CIFAR10_CUSTOM_TO_STANDARD_LAYER_NAME_MAPPING,
    VGG19_CIFAR10_STANDARD_TO_CUSTOM_LAYER_NAME_MAPPING
)
...
class VGG19Cifar10(LayerComposite):
    def __init__(self, configs_network_masks: ConfigsNetworkMasksImportance):
        ...
        for layer_attr in VGG19_CIFAR10_REGISTERED_LAYERS_ATTRIBUTES:
        ...
        for layer_attr in VGG19_CIFAR10_UNREGISTERED_LAYERS_ATTRIBUTES:
            name = layer_attr['name']
            type_ = layer_attr['type']
    ...
    def forward(self, x):
        return forward_pass_vgg19_cifars_version2(self, x, VGG19_CIFAR10_REGISTERED_LAYERS_ATTRIBUTES, VGG19_CIFAR10_UNREGISTERED_LAYERS_ATTRIBUTES)
    ...
    def save(self, name: str, folder: str):
        save_model_weights(
            ...
            model_name=name,
            folder_name=folder,
            custom_to_standard_mapping=VGG19_CIFAR10_CUSTOM_TO_STANDARD_LAYER_NAME_MAPPING,
            skip_array=[]
        )

    def load(self, path: str, folder: str = PRUNED_MODELS_PATH):
        load_model_weights(
            model=self,
            model_name=path,
            folder_name=folder,
            standard_to_custom_mapping=VGG19_CIFAR10_STANDARD_TO_CUSTOM_LAYER_NAME_MAPPING,
            skip_array=[]
        )
