...
class ModelCifar10Conv6(nn.Module):
    def __init__(self, configs_network_masks: ConfigsNetworkMasks):
        ...
        configs_conv2d_3: ConfigsConv2D = {
            'in_channels': 64,
            'out_channels': 128,
            'kernel_size': 3,
            'padding': 1,
        ...
        configs_conv2d_4: ConfigsConv2D = {
            'in_channels': 128,
            'out_channels': 128,
            'kernel_size': 3,
            'padding': 1,
        ...
        configs_conv2d_5: ConfigsConv2D = {
            'in_channels': 128,
            'out_channels': 256,
            'kernel_size': 3,
            'padding': 1,
        ...
        configs_conv2d_6: ConfigsConv2D = {
            'in_channels': 256,
            'out_channels': 256,
            'kernel_size': 3,
            'padding': 1,
    ...
    def get_masked_loss(self) -> torch.Tensor:
        ...
        for layer in [self.fc1, self.fc2, self.fc3, self.conv2D_1, self.conv2D_2, self.conv2D_3, self.conv2D_4, self.conv2D_5, self.conv2D_6]:
