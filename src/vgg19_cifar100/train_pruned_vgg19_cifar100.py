...
def initialize_model():
    ...
    MODEL.load(BASELINE_VGG19_CIFAR100, BASELINE_MODELS_PATH)
...
def train_cifar100_vgg19_sparse_model_adam():
    ...
    MODEL.save(
        name= f"vgg19_cifar100_sparsity{get_model_sparsity_percent(MODEL)}_acc{acc}",
