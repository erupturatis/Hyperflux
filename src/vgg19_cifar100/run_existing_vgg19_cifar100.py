...
from src.vgg19_cifar100.vgg19_cifar100_attributes import VGG19_CIFAR100_STANDARD_TO_CUSTOM_LAYER_NAME_MAPPING
...
def run_cifar10_vgg19_existing_model(model_name:str, folder: str):
    ...
    get_sparsity(
        model=model,
        standard_to_custom_attributes=VGG19_CIFAR100_STANDARD_TO_CUSTOM_LAYER_NAME_MAPPING
    )
