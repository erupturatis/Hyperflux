...
from src.infrastructure.others import get_device, get_custom_model_sparsity_percent, TrainingConfigsNPLHL0
...
def train_resnet50_cifar10_L0_cont_registering(sparsity_configs_aux: TrainingConfigsNPLHL0):
