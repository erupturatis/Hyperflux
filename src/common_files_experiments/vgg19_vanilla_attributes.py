...
VGG19_VANILLA_REGISTERED_LAYERS_ATTRIBUTES = [
    {"name": "conv1_1", "type": CONV2D_LAYER, "in_channels": 3, "out_channels": 64,
     "kernel_size": 3, "stride": 1, "padding": 1, "bias_enabled": True},
...
VGG19_VANILLA_CUSTOM_TO_STANDARD_LAYER_NAME_MAPPING = [
    ...
    {'custom_name': 'conv1_2', 'standard_name': 'features.2.weight'},

    # Block 2
    {'custom_name': 'conv2_1', 'standard_name': 'features.5.weight'},
    {'custom_name': 'conv2_2', 'standard_name': 'features.7.weight'},

    # Block 3
    {'custom_name': 'conv3_1', 'standard_name': 'features.10.weight'},
    {'custom_name': 'conv3_2', 'standard_name': 'features.12.weight'},
    {'custom_name': 'conv3_3', 'standard_name': 'features.14.weight'},
    {'custom_name': 'conv3_4', 'standard_name': 'features.16.weight'},

    # Block 4
    {'custom_name': 'conv4_1', 'standard_name': 'features.19.weight'},
    {'custom_name': 'conv4_2', 'standard_name': 'features.21.weight'},
    {'custom_name': 'conv4_3', 'standard_name': 'features.23.weight'},
    {'custom_name': 'conv4_4', 'standard_name': 'features.25.weight'},

    # Block 5
    {'custom_name': 'conv5_1', 'standard_name': 'features.28.weight'},
    {'custom_name': 'conv5_2', 'standard_name': 'features.30.weight'},
    {'custom_name': 'conv5_3', 'standard_name': 'features.32.weight'},
    {'custom_name': 'conv5_4', 'standard_name': 'features.34.weight'},
