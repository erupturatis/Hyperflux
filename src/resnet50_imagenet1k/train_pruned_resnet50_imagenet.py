...
def initialize_stages_context():
    ...
    pruning_scheduler = PressureScheduler(pressure_exponent_constant=1.5, sparsity_target=sparsity_configs["target_sparsity"], epochs_target=pruning_end, step_size=0.15)
    scheduler_decay_after_pruning = sparsity_configs["lr_flow_params_decay_regrowing"]
...
def train_resnet50_imagenet_sparse_model(sparsity_configs_aux):
    global epoch_global, MODEL_MODULE, sparsity_configs
