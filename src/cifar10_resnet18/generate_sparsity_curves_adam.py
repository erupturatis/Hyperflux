...
from src.infrastructure.constants import LR_FLOW_PARAMS_ADAM, config_adam_setup, LR_FLOW_PARAMS_RESET, \
    get_lr_flow_params_reset, get_lr_flow_params, BASELINE_RESNET18_CIFAR10
...
def generate_cifar10_resnet18_adam_sparsity_curve(arg:float, power_start:int, power_end:int):
