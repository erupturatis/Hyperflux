...
from src.vgg19_cifar100.train_sparsity_curves_adam import generate_cifar100_vgg19_adam_sparsity_curve
...
if __name__ == "__main__":
   generate_cifar100_vgg19_adam_sparsity_curve(arg=2, power_start=1, power_end=1)
   pass